...
public class GenAccTM {
    ...
    public GenAccTM(String accNo, String accName, String accType, String accCate, String accSubCate, double accOpenValue, String accHolder, String accDetail, double accCurValue) {
        this.accNo = accNo;
    ...
    public GenAccTM(String accNo, String accName, String accCate, String accSubCate, String accDetail) {
        this.accNo = accNo;
        this.accName = accName;
        this.accCate = accCate;
        this.accSubCate = accSubCate;
