...
@Entity
public class PurOrderDetail implements SuperEntity {
    ...
    public PurOrderDetail(int orderId, int oNo, String iCode, Double noOfItem, Double pack, Double purPrice, Double discount, Double margin) {
