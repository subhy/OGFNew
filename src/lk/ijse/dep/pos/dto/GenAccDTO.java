...
public class GenAccDTO {
    ...
    public GenAccDTO(String accNo, String accName, String accType, String accCate, String accSubCate, double accOpenValue, String accHolder, String accDetail, double accCurValue) {
        this.accNo = accNo;
