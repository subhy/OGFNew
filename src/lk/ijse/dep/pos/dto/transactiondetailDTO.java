...
public class transactiondetailDTO {
    ...
    public transactiondetailDTO(String transNo, Date transDate, String transAccNo, String transCate, String transSubCate, String transDesc, String transType, Double transAmount, String transUserId) {
    ...
    public transactiondetailDTO(String transNo, Date transDate, String transAccNo, String transCate, String transSubCate, String transDesc, String transType, Double transAmount, String transUserId, String transUserName) {
        this.transNo = transNo;
        this.transDate = transDate;
        this.transAccNo = transAccNo;
        this.transCate = transCate;
